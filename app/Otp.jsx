...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 24, color: '#795805ff', fontWeight: 'bold', marginBottom: 10 },
  ...
  verifyButton: { backgroundColor: '#795805ff', paddingVertical: 15, paddingHorizontal: 60, borderRadius: 8, marginBottom: 20, width: '70%', alignItems: 'center', justifyContent: 'center' },
