...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 24, fontWeight: 'bold', color: '#795805ff', marginBottom: 20, textAlign: 'center' },
  ...
  icon: { marginLeft: 10 },
  button: { height: 50, backgroundColor: '#795805ff', justifyContent: 'center', alignItems: 'center', borderRadius: 5 },
