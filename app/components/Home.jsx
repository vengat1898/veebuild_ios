...
import MenuDrawer from './MenuDrawer'; // Import the new component
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    loadInitialData();
  }, [mounted, safeApiCall, fetchMaterials, fetchTrendingProducts, fetchMostEnquiredProducts, fetchMostSearchedProducts, requestLocationPermission]);
  ...
  // Static data for hire categories
  const hireCategories = ["Engineering", "Architect", "Plumber"];
      ...
      <LinearGradient colors={["#FFE5B5", "#FFDFA0"]} style={styles.header}>
        <View style={styles.headerTop}>
          ...
          >
            ...
            {isLocationLoading ? (
              <ActivityIndicator size="small" color="#FF8800" style={{ marginHorizontal: 5 }} />
            ) : (
          ...
          >
            {brands.map((img, index) => (
              <View key={index} style={styles.brandCard}>
                <Image source={img} style={styles.brandImage} resizeMode="contain" />
              </View>
            ))}
          </ScrollView>
        </ScrollView>
