...
export default function Shopdetails() {
  ...
  const styles = createStyles(windowWidth, windowHeight, insets);
      ...
      <LinearGradient
        ...
        style={[
          ...
          { 
            ...
            height: insets.top + (Platform.OS === 'ios' ? 70 : 60)
          }
        ]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
...
const createStyles = (windowWidth, windowHeight, insets) =>
  StyleSheet.create({
    container: {
      flex: 1,
      backgroundColor: '#F5F5F5',
    ...
    scrollContent: {
      paddingBottom: Platform.OS === 'ios' ? 120 : 110, // Extra padding for Android to ensure content doesn't hide behind buttons
      flexGrow: 1,
    },
    shopCard: {
      backgroundColor: 'white',
      ...
      shadowRadius: 12,
      elevation: 5,
      marginTop: Platform.OS === 'ios' ? 0 : 10, // Slight adjustment for Android
    },
    imageWrapper: {
      width: '100%',
      marginBottom: 16,
    ...
    contentContainer: {
      ...
      shadowRadius: 8,
      elevation: 3,
      marginBottom: Platform.OS === 'ios' ? 0 : 10, // Extra margin for Android
    },
    sectionHeader: {
      flexDirection: 'row',
      alignItems: 'center',
    ...
    buttonContainer: {
      ...
      paddingHorizontal: 20,
      paddingTop: 16,
      paddingBottom: Platform.OS === 'ios' ? Math.max(insets.bottom, 16) : Math.max(insets.bottom, 20),
      borderTopWidth: 1,
      borderTopColor: '#F0F0F0',
      shadowColor: '#000',
      shadowOffset: { width: 0, height: -2 },
