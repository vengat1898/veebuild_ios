...
export default function HotenquiryForm() {
  ...
  const handleSignIn = async () => {
    console.log("Sign in clicked from Hot Enquiry Form");
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Text style={styles.headerText}>Hot Enquiry Form</Text>
        </LinearGradient>
        ...
        <View style={styles.guestContainer}>
          ...
          <Text style={styles.guestMessage}>
            You need to be logged in to submit hot enquiries. Please sign in to access this feature.
          </Text>
